...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'doanh-thu', name: 'DoanhThu', component: () => import('../views/DoanhThuView.vue'), meta: { role: ['admin', 'accountant'] } },
      ...
      { path: 'chanh', name: 'Chanh', component: () => import('../views/ChanhView.vue'), meta: { role: ['admin'] } },
      { path: 'thu-ho', name: 'ThuHo', component: () => import('../views/ThuHoView.vue'), meta: { role: ['admin', 'accountant'] } },
    ],
  },
  {
    path: '/scan',
